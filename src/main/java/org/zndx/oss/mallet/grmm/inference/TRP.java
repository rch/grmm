...
public class TRP extends AbstractBeliefPropagation {
  ...
  private static org.zndx.oss.mallet.grmm.types.Tree graphToTree (Graph g) throws Exception
  {
    // Perhaps handle gracefully?? -cas
    if (g.vertexSet ().size () <= 0) {
      throw new RuntimeException ("Empty graph.");
    }
    Tree tree = new org.zndx.oss.mallet.grmm.types.Tree ();
  ...
  public interface TreeFactory extends Serializable {
    public org.zndx.oss.mallet.grmm.types.Tree nextTree (FactorGraph mdl);
  }
  ...
  static public class TreeListFactory implements TreeFactory {
    ...
    public TreeListFactory (org.zndx.oss.mallet.grmm.types.Tree[] arr)
    {
    ...
    public org.zndx.oss.mallet.grmm.types.Tree nextTree (FactorGraph mdl)
    {
      ...
      return (org.zndx.oss.mallet.grmm.types.Tree) it.next ();
    }
...
/*
  ...
  public void computeMarginals (FactorGraph m)
  {
    ...
    while (terminator.shouldContinue (this)) {
      ...
      org.zndx.oss.mallet.grmm.types.Tree tree = factory.nextTree (m);
      propagate (tree);
//      dump();
    }
    iterUsed = iter;
  ...
  private void propagate (org.zndx.oss.mallet.grmm.types.Tree tree)
  {
  ...
  private void lambdaPropagation (org.zndx.oss.mallet.grmm.types.Tree tree, Object parent, Object child)
  {
  ...
  private void piPropagation (org.zndx.oss.mallet.grmm.types.Tree tree, Object parent)
  {
