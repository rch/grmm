...
package org.zndx.oss.mallet.projects.seg_plus_coref.clustering;

import org.zndx.oss.mallet.base.pipe.Pipe;
import org.zndx.oss.mallet.base.types.Instance;
import org.zndx.oss.mallet.base.types.Token;
import org.zndx.oss.mallet.base.types.TokenSequence;
import org.zndx.oss.mallet.base.util.CharSequenceLexer;
//import org.zndx.oss.mallet.users.fuchun.coref.SGMLStringOperation;
//cas: changed above line to: I hope that doesn't introduce a bug
import org.zndx.oss.mallet.projects.seg_plus_coref.coreference.SGMLStringOperation;
