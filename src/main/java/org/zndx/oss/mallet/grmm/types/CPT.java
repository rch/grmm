...
package org.zndx.oss.mallet.grmm.types;
...
/**
 * $Id: CPT.java,v 1.3 2006/02/03 04:25:32 casutton Exp $
 */
public class CPT implements DiscreteFactor {
  ...
  public Assignment sample (Random r) {return subFactor.sample (r);}
  ...
  public int sampleLocation (Random r) {return subFactor.sampleLocation (r);}
  ...
  public String dump () { return subFactor.dump (); }
