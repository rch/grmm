...
package org.zndx.oss.mallet.base.pipe.tests;

import junit.framework.*;
import org.zndx.oss.mallet.base.pipe.Pipe;
import org.zndx.oss.mallet.base.pipe.SimpleTaggerSentence2TokenSequence;
...
import org.zndx.oss.mallet.base.fst.SimpleTagger;

/**
 * Created: Aug 28, 2005
 *
 * @author <A HREF="mailto:casutton@cs.umass.edu>casutton@cs.umass.edu</A>
 * @version $Id: TestPipeUtils.java,v 1.1 2006/07/23 12:55:09 casutton Exp $
 */
public class TestPipeUtils extends TestCase {
  ...
  private static class StupidPipe extends Pipe {
    ...
    {
      System.out.println ("StupidPipd says hi.");
      return carrier;
    }
  }
  ...
  public void testPipesAreStupid ()
  {
    ...
    new Instance (data, null, null, null, p2);
