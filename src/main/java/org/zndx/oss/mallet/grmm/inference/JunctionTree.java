 ...
 * @version $Id: JunctionTree.java,v 1.8 2006/02/03 04:25:32 casutton Exp $
 */
public class JunctionTree extends Tree {
  ...
  public void addNode (Object parent1, Object child1)
  {
    ...
    putSepset(id1, id2, new Sepset (sepset, new TableFactor (sepset)));
  }
...
// Debugging functions
  ...
  public void dump()
  {
    ...
    for (int i = 0; i < n; i++) {
      if (cpfs[i] != null) {
        System.out.println("CPF "+i+" "+cpfs[i].dump ());
      }
    }
