...
import org.zndx.oss.mallet.base.util.ArrayUtils;
import org.zndx.oss.mallet.grmm.inference.RandomGraphs;
import org.zndx.oss.mallet.grmm.types.*;
import org.zndx.oss.mallet.grmm.util.Graphs;
 ...
 * @version $Id: TestUndirectedModel.java,v 1.10 2006/02/06 20:45:01 casutton Exp $
 */
public class TestUndirectedModel extends TestCase {
  ...
  public void testMultipleEdgePotentials ()
  {
    ...
    Factor total = mdl.factorOf (v1, v2);

    Collection factors = mdl.allFactorsOverVars (new HashVarSet (vars));
  ...
  public void testMdlToGraph ()
  {
    ...
    for (Iterator mdlIt = models.iterator (); mdlIt.hasNext ();) {
      ...
      while (it.hasNext ()) {
        ...
        Iterator factorIt = mdl.allFactorsOfVar (var).iterator ();
