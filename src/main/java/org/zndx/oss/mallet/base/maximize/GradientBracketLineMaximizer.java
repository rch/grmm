...
package org.zndx.oss.mallet.base.maximize;

import org.zndx.oss.mallet.base.maximize.Maximizable;
import org.zndx.oss.mallet.base.types.Matrix;
...
public class GradientBracketLineMaximizer implements LineMaximizer.ByGradient {
	private static Logger logger = MalletLogger.getLogger(GradientBracketLineMaximizer.class.getName());
	
	int maxIterations = 50;

	public double maximize (Maximizable function, Matrix line, double initialStep) {
		return maximize ((Maximizable.ByGradient)function, line, initialStep);
	}
	...
	public double maximize (Maximizable.ByGradient function, double[] line, double initialStep)
	{
		...
		double[] parameters = new double[function.getNumParameters()];
		double[] gradient = new double[function.getNumParameters()];
		...
		logger.info ("Ending cost = "+function.getValue());
