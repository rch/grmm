...
import org.zndx.oss.mallet.grmm.learning.GenericAcrfData2TokenSequence;

/**
 * Created: Sep 15, 2005
 *
 * @author <A HREF="mailto:casutton@cs.umass.edu>casutton@cs.umass.edu</A>
 * @version $Id: TestGenericAcrfData2TokenSequence.java,v 1.4 2006/05/10 15:31:08 casutton Exp $
 */
public class TestGenericAcrfData2TokenSequence extends TestCase {
  ...
  public void testFromSerialization () throws IOException, ClassNotFoundException
  {
    ...
    Instance inst1 = l1.getInstance (0);
    Instance inst2 = l2.getInstance (0);
  ...
  public void testFixedNumLabels () throws IOException, ClassNotFoundException
  {
    ...
    Instance inst1 = training.getInstance (0);
    LabelsSequence ls1 = (LabelsSequence) inst1.getTarget ();
