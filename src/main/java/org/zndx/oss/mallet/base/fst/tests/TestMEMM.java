package org.zndx.oss.mallet.base.fst.tests;

import org.zndx.oss.mallet.base.extract.StringSpan;
import org.zndx.oss.mallet.base.extract.StringTokenization;
import org.zndx.oss.mallet.base.fst.MEMM;
import org.zndx.oss.mallet.base.fst.Transducer;
import org.zndx.oss.mallet.base.maximize.Maximizable;
import org.zndx.oss.mallet.base.maximize.tests.TestMaximizable;
import org.zndx.oss.mallet.base.pipe.*;
import org.zndx.oss.mallet.base.pipe.iterator.ArrayIterator;
import org.zndx.oss.mallet.base.pipe.tsf.OffsetConjunctions;
import org.zndx.oss.mallet.base.pipe.tsf.TokenText;
import org.zndx.oss.mallet.base.types.*;
import org.zndx.oss.mallet.base.types.tests.TestSerializable;
...
public class TestMEMM extends TestCase {
	...
	public void testGetSetParameters()
	{
	  ...
	  MEMM.MaximizableCRF mcrf = memm.getMaximizableCRF(new InstanceList(null));
...
//    memm.setGaussianPriorVariance (Double.POSITIVE_INFINITY);
    Maximizable.ByGradient mcrf = memm.getMaximizableCRF(training);
    TestMaximizable.setNumComponents (150);
    TestMaximizable.testValueAndGradient (mcrf);
  }
  ...
  public void testSpaceSerializable () throws IOException, ClassNotFoundException
  {
    ...
    Maximizable.ByGradient mcrf1 = memm.getMaximizableCRF(training);
    double val1 = mcrf1.getValue ();
    Maximizable.ByGradient mcrf2 = memm2.getMaximizableCRF(training);
	...
	public void disabledtestCost(int useSave)
	{
	  ...
	  MEMM.MaximizableCRF mcrf = crf.getMaximizableCRF(ilist);
