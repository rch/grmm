...
package org.zndx.oss.mallet.base.maximize.tests;
 ...
 * @version $Id: TestMaximizer.java,v 1.3 2006/01/09 18:53:58 gdruck Exp $
 */
public class TestMaximizer extends TestCase {
	...
	public void testConjugateGradient() {
		SimplePoly poly = new SimplePoly();
		Maximizer.ByGradient cg = new ConjugateGradient();
		cg.maximize(poly);
		assertEquals(5.0 / 6.0, poly.params[0], 1e-3);
	}
