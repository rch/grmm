...
public class NaiveBayesTrainer extends IncrementalClassifierTrainer implements Boostable, Serializable
{
                                        ...
                                        Classifier initialClassifier)
	{
	    ...
	    // ugly, but works - gdruck
	    // now we can set the featureEstimator type!
            if (featureEstimator instanceof Multinomial.LaplaceEstimator) {
            	me = new Multinomial.LaplaceEstimator[numLabels];
            }
            else if (featureEstimator instanceof Multinomial.MAPEstimator) {
            	me = new Multinomial.MAPEstimator[numLabels];
            }
            else if (featureEstimator instanceof Multinomial.MEstimator) {
            	me = new Multinomial.MEstimator[numLabels];
            }
            else if (featureEstimator instanceof Multinomial.MLEstimator) {
            	me = new Multinomial.MEstimator[numLabels];
            }
