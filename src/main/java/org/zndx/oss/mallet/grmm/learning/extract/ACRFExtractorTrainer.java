...
package org.zndx.oss.mallet.grmm.learning.extract;

import org.zndx.oss.mallet.base.extract.Extraction;
import org.zndx.oss.mallet.base.extract.TokenizationFilter;
import org.zndx.oss.mallet.base.pipe.Pipe;
import org.zndx.oss.mallet.base.pipe.PipeUtils;
import org.zndx.oss.mallet.base.pipe.iterator.PipeInputIterator;
import org.zndx.oss.mallet.base.types.InstanceList;
import org.zndx.oss.mallet.base.util.FileUtils;
import org.zndx.oss.mallet.base.util.CollectionUtils;
...
import org.zndx.oss.mallet.grmm.learning.ACRFTrainer;
import org.zndx.oss.mallet.grmm.learning.AcrfSerialEvaluator;
import org.zndx.oss.mallet.grmm.util.PipedIterator;
import org.zndx.oss.mallet.grmm.util.RememberTokenizationPipe;
 ...
 * @version $Id: ACRFExtractorTrainer.java,v 1.2 2006/09/29 16:27:53 casutton Exp $
 */
public class ACRFExtractorTrainer {
  ...
  public ACRFExtractorTrainer setDataSource (PipeInputIterator trainIterator, PipeInputIterator testIterator)
  {
