 ...
 * @version $Id: TestRandomGraphs.java,v 1.8 2006/02/03 04:25:32 casutton Exp $
 */
public class TestRandomGraphs extends TestCase {
  ...
  public void testFrustratedIsGrid () throws IOException
  {
    ...
    for (int rep = 0; rep < 100; rep++) {
      ...
      assertEquals (counts[2], 4);
      assertEquals (counts[3], 32);
      assertEquals (counts[4], 64);
    }
  }
  ...
  public void testUniformGrid ()
  {
    ...
    for (AssignmentIterator it = joint.assignmentIterator (); it.hasNext();) {
