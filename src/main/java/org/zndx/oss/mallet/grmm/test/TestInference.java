...
package org.zndx.oss.mallet.grmm.test;

import org.zndx.oss.mallet.base.types.Matrix;
import org.zndx.oss.mallet.base.types.Matrixn;
import org.zndx.oss.mallet.base.types.Dirichlet;
import org.zndx.oss.mallet.base.types.tests.TestSerializable;
import org.zndx.oss.mallet.base.util.*;
import org.zndx.oss.mallet.grmm.inference.*;
import org.zndx.oss.mallet.grmm.types.*;
import org.zndx.oss.mallet.grmm.util.GeneralUtils;
 ...
 * @version $Id: TestInference.java,v 1.23 2006/02/03 04:25:32 casutton Exp $
 */
...
//          continue;
  ...
  private Inferencer[] constructAllAppxInferencers () throws IllegalAccessException, InstantiationException
  {
    ...
    algs.add (new SamplingInferencer (new GibbsSampler (100), 10000));
...
//      System.out.println(mdl);
  ...
  {
    int NUM_OUTCOMES = 2;
    org.zndx.oss.mallet.base.util.Random random = new org.zndx.oss.mallet.base.util.Random (13413);
