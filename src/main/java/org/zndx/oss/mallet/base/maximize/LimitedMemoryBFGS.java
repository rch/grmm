...
import org.zndx.oss.mallet.base.maximize.LineMaximizer;
import org.zndx.oss.mallet.base.maximize.Maximizable;
import org.zndx.oss.mallet.base.maximize.BackTrackLineSearch;
...
public class LimitedMemoryBFGS implements Maximizer.ByGradient
{
	...
	private LineMaximizer.ByGradient lineMaximizer = new BackTrackLineSearch();
       ...
       public void setLineMaximizer (LineMaximizer.ByGradient maxer)
       {
         lineMaximizer = maxer;
       }
  ...
  public boolean maximize (Maximizable.ByGradient maxable)
	...
	public boolean maximize (Maximizable.ByGradient maxable, int numIterations)
	{
		...
		for(int iterationCount = 0; iterationCount < numIterations;
			...
			if ( sy > 0 ) {
        throw new InvalidMaximizableException ("sy = "+sy+" > 0" );
      }

			double gamma = sy / yy;	 // scaling factor
			if ( gamma>0 )
			    throw new InvalidMaximizableException ("gamma = "+gamma+" > 0" );
