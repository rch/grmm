 ...
 * @version $Id: PipeUtils.java,v 1.2 2006/02/03 17:25:24 casutton Exp $
 */
public class PipeUtils {
  ...
  public static Pipe concatenatePipes (Pipe p1, Pipe p2)
  {
    ...
    ret.dataDict = dataDict;
    ret.targetDict = targetDict;
    return ret;
  }

  private static Alphabet combinedDataDicts (Pipe p1, Pipe p2)
  {
    if (p1.dataDict == null) return p2.dataDict;
    if (p2.dataDict == null) return p1.dataDict;
    if (p1.dataDict == p2.dataDict) return p2.dataDict;
  ...
  {
    if (p1.targetDict == null) return p2.targetDict;
    if (p2.targetDict == null) return p1.targetDict;
    if (p1.targetDict == p2.targetDict) return p2.targetDict;
